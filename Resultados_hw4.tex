...
\begin{figure}[H]
    \centering
    \subfigure[]{\label{fig:proyectilAngulo45}\includegraphics[scale = 0.4]{proyectilAngulo45}}
...
\begin{figure}[H]
    \centering
    \subfigure[]{\label{fig:temperaturaCondFi1}\includegraphics[scale = 0.5]{temperaturaCondFi1}}
    \subfigure[]{\label{fig:temperaturaCondFi2}\includegraphics[scale = 0.5]{temperaturaCondFi2}}
    \subfigure[]{\label{fig:temperaturaCondFi3}\includegraphics[scale = 0.5]{temperaturaCondFi3}}
    \subfigure[]{\label{fig:temperaturaCondFi4}\includegraphics[scale = 0.5]{temperaturaCondFi4}}
...
\begin{figure}[H]
    \centering
    \subfigure[]{\label{fig:temperaturaCondAb1}\includegraphics[scale = 0.5]{temperaturaCondAb1}}
    \subfigure[]{\label{fig:temperaturaCondAb2}\includegraphics[scale = 0.5]{temperaturaCondAb2}}
    \subfigure[]{\label{fig:temperaturaCondAb3}\includegraphics[scale = 0.5]{temperaturaCondAb3}}
    \subfigure[]{\label{fig:temperaturaCondAb4}\includegraphics[scale = 0.5]{temperaturaCondAb4}}
...
\begin{figure}[H]
    \centering
    \subfigure[]{\label{fig:temperaturaCondPe1}\includegraphics[scale = 0.5]{temperaturaCondPe1}}
    \subfigure[]{\label{fig:temperaturaCondPe2}\includegraphics[scale = 0.5]{temperaturaCondPe2}}
    \subfigure[]{\label{fig:temperaturaCondPe3}\includegraphics[scale = 0.5]{temperaturaCondPe3}}
    \subfigure[]{\label{fig:temperaturaCondPe4}\includegraphics[scale = 0.5]{temperaturaCondPe4}}
